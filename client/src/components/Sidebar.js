...
const Sidebar = () => {
  ...
  return (
    <div className={`${isOpen ? 'right-0' : '-right-full'} w-full h-full bg-white fixed top-0 shadow-2xl md:w-[35vw] xl:max-w-[38vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
